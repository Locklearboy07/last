...
api_key = "o039C26C7F5316ab9891ed924b3A4885BF35C70FE"
...
# response = _request_without_params(GET, SERVICE_STATUS)
# services = []
...
# data = json.loads(response.content)['data']
# The above code is parsing a JSON response and extracting the 'data' field from it.
...
# The above code is defining a function in Python that returns the variable "trades".
# return trades
...
# response = self._request_with_params(POST, MARKING_REPAY,
#  params=dict(symbol=symbol, currency=currency, amount=amount),
#  auth=Auth.SIGNED)
...
#  start_time: Optional[datetime] = None,python script.py
#  end_time: Optional[datetime] = None,
#  records_count: Optional[int] = None) -> List[RepayRecord]:

# {
# "type": "sphinx",
# "command": "TeX_LaunchInstaller",
# "label": "TeX: Launch the installer.(It will take some time to install. Please reboot your PC after installation.)",
# "problemMatcher": [],
# "group": {
# "kind": "build",
# "isDefault": true
...
# response = self._request_with_params(GET, MARKING_REPAYMENT_RECORD, params=params, auth=Auth.KEYED)
...
# Configure the test to go to the test explorer
# unittest.TestRunner._show_test_explorer = True
